...
{
    public class SavedOriginalProgram
    {
        //using Project1.Data;
            ...
            public static void Main()
            {
                ...
                while (true)
                {
                    ...
                    if (selected == 1)
                    {
                        ...
                        {//Employee.checkLogExists(username,password)) { 
                    ...
                    else
                    {
                        ...
                        {//!Employee.checkUserExists(username) && !FinanceManager.checkExists(username,password)) {
